...
const styles = {
    ...
    navbar:{
        ...
        boxShadow:"box-shadow: 0 0.5em 1em -0.125em rgb(10 10 10 / 10%), 0 0 0 1px rgb(10 10 10 / 2%)"   
    },
    ham__bg__container:{
        display:"none",
...
function Navbar({classes}) {
    ...
    return (
        ...
        <header className={classes.header} >
                    ...
                    <div >
                        ...
                        <div className={classes.menuContainer__lg}>
                            <div className={classNames(classes.menuContainer__lg__menu,classes.flex)}>
                                <div  onClick={()=>{window.location.href = "mailto:mahe365param@email.com"}} className={classNames(classes.flex,classes.mgR10)}>
                                ...
                                <div onClick={()=>goTo("https://www.linkedin.com/in/mahen96/")} className={classNames(classes.flex,classes.mgR10)}>
                                ...
                                <div onClick={()=>goTo("https://twitter.com/MAHENPARAMESHW1")} className={classNames(classes.flex,classes.mgR10)}>
                                ...
                                <div onClick={()=>goTo("https://github.com/MahenParameshwar")} className={classNames(classes.flex,classes.mgR10)}>
                                ...
                                <div onClick={aboutSection.onClick} selected={aboutSection.selected}  className={classes.menuItem}>
                                    About
                                </div>
                                <div onClick={contactSection.onClick} selected={contactSection.selected} className={classes.menuItem}>
                                    Contact
                                </div>
                        </div>
            ...
            <div className={classNames(classes.menuContainer__sm,{[classes.active]:isOpen})}>
                    <div onClick={aboutSection.onClick} selected={aboutSection.selected}  className={classes.menuItem}>
                            About
                    </div>
                    <div onClick={contactSection.onClick} selected={contactSection.selected} className={classes.menuItem}>
